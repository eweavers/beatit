...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/games/new'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/gamesreqs/'), [0 => 'ROLE_USER'], NULL);
