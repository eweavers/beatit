...
// Returns the private 'App\Repository\AdministratorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AdministratorRepository.php';

return $this->privates['App\\Repository\\AdministratorRepository'] = new \App\Repository\AdministratorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
